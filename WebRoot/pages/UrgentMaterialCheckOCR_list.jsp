...
<script type="text/javascript">
  $(function () {
   ...
   function init(){
      setInterval("refresh()",300000); //60000 = 1s
   }
    ...
    <div class="king-page-box">
        <div class="king-container clearfix">    
            ...
            <div class="king-block-header king-gray-light" align="center">
                <table>
	            	<tr>
		            	<td><h3 class="king-block-title" style="font-size:32px;">2b.急料检验看板（OCR）</h3></td>
		            	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		            	<td>
		            		<table border="1" >
			                	<tr>                               
                        ...
                        <table class="table table-bordered" id="table_demo2">
                            <thead>
                                <tr>                        
                                    ...
                                    <th style="font-size:18px;color:#000">OCR 检验等待时间(H)</th>                                                           
                                </tr>
                            </thead>
                            <tbody>
                            <% int index = 0; %>
                            
                            <s:iterator value="#request.urgentMaterialCheckOCRList" var="d">                                                          
                                <tr <%if((index++)%2==0){out.print("style=background:#F5F5F5");}else{out.print("class='row1'");} %> onMouseOver="mouseover(this)" onMouseOut="mouseout(this)">                                  
                                    ...
                                    <td><s:property value='#d.OCRCheckWaitTime'/></td>                                                                    
                                </tr>                                          
                            </s:iterator>
