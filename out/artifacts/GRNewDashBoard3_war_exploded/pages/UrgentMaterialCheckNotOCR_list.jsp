    ...
    <div class="king-page-box">
        <div class="king-container clearfix">    
            ...
            <div class="king-block-header king-gray-light" align="center">
                <table>
	            	<tr>
		            	<td><h3 class="king-block-title" style="font-size:32px;">2a.急料检验看板（非OCR）</h3></td>
		            	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		            	<td>
		            		<table border="1" >
			                	<tr>                               
                        ...
                        <table class="table table-bordered" id="table_demo2">
                            <thead>
                                <tr>                               
                                    ...
                                    <th style="font-size:18px;color:#000">收货部完成收货时间</th>
                                    <th style="font-size:18px;color:#000">急料类别</th>
                                    <th style="font-size:18px;color:#000">IQC取样时间</th>
                                    <th style="font-size:18px;color:#000">IQC检验等待时间(H)</th>
                                    <!-- <th>IQC交还时间</th> -->
                                    <!-- <th>IQC检验工时</th> -->
                                    <!-- <th>IQC上传SAP时间</th> -->                               
                                </tr>
                            ...
                            <s:iterator value="#request.urgentMaterialCheckNotOCRList" var="d">                                                          
                                <tr <%if((index++)%2==0){out.print("style=background:#F5F5F5");}else{out.print("class='row1'");} %> onMouseOver="mouseover(this)" onMouseOut="mouseout(this)">                                  
                                    ...
                                    <td><s:property value='#d.RDFinishTime'/></td>
                                    <td><s:property value='#d.type'/></td> 
                                    <td><s:property value='#d.IQCGetTime'/></td>
                                    <td><s:property value='#d.IQCCheckWaitTime'/></td>
                                    <!-- <td><s:property value='#d.IQCReturnTime'/></td>
                                    <td><s:property value='#d.IQCCheckTime'/></td>
                                    <td><s:property value='#d.IQCUploadTimeToSAP'/></td> -->                                                       
                                </tr>                                          
                            </s:iterator>
