    ...
    <div class="king-page-box">
        <div class="king-container clearfix">    
            ...
            <div class="king-block-header king-gray-light" align="center">
            	<table>
	            	<tr>
		            	<td><h3 class="king-block-title" style="font-size:32px;">1.待点收看板</h3></td>
		            	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		            	<td>
		            		<table border="1" >
			                	<tr>                               
                        ...
                        <table class="table table-bordered" id="table_demo2">
                            <thead>
                                <tr>                               
                                    ...
                                    <th style="font-size:18px;color:#000">工厂</th>
                                    <th style="font-size:18px;color:#000">物料编号 &nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="导出" onclick="doExport()" style="width: 50px" />		</th>
                                    <th style="font-size:18px;color:#000">GRN数量</th>
                                    <th style="font-size:18px;color:#000">UID个数</th>
                                    <th style="font-size:18px;color:#000">急料类别</th>
                                    <th style="font-size:18px;color:#000">待收料等待时间(H)</th>                                
                                </tr>
                            </thead>
                            <tbody>
                            <% int index = 0; %>
                            
                            <s:iterator value="#request.toReceiveCheckList" var="d">                                                          
